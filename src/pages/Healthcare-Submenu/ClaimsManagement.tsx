...
const ClaimsManagement: React.FC = () => {
  ...
  // Healthcare Portfolio - 3 submenus (Claims Management is current page, so removed)
  const healthcarePortfolio = [
    ...
    // Claims Management is the current page, so it's removed from portfolio
    {
  ...
  return (
    <div id='claims-management' className="min-h-screen bg-gray-50">
